...
print(BLUE + "NXScan[1.1] by ARPSyndicate" + CLEAR)
...
if len(sys.argv)<2:
    ...
    parser.add_option('--naabu-param', action="store", dest="napara", help="naabu parameters [default= -top-ports 1000 -rate 800 -timeout 1500 -privileged -silent -retries 5]", default="-top-ports 1000 -rate 800 -timeout 1500 -privileged -silent -retries 5  ")
